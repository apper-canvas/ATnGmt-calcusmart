...
import { Trash2, RotateCcw, Percent, Divide, X, Minus, Plus, Equal, Calculator } from 'lucide-react'
...
const MainFeature = ({ onCalculate }) => {
  ...
  }, [display, expression, lastOperation, isCalculated])
      ...
      <div className="p-6 bg-gradient-to-r from-primary/10 to-secondary/10 dark:from-primary/5 dark:to-secondary/5">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-surface-800 dark:text-surface-100">CalcuSmart</h2>
          </div>
